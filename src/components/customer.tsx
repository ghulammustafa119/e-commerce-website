          ...
          <Carousel className="w-full relative">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex items-center gap-3 shrink-0 ml-3">
                <CarouselPrevious className="static translate-y-0 translate-x-0 left-auto top-auto w-8 h-8 md:w-10 md:h-10 text-gray-600 hover:text-black" />
                <CarouselNext className="static translate-y-0 translate-x-0 right-auto top-auto w-8 h-8 md:w-10 md:h-10 text-gray-600 hover:text-black" />
              </div>
            </div>
