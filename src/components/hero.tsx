...
//     <>
//       {/* Hero Section */}
//        <div className="w-full h-auto max-w-screen-2xl mx-auto md:h-[663px] flex flex-col items-start bg-[#f2f0f1] md:flex-row md:justify-center md:mx-20">
//         {/* Left Content */}
...
//         <div className="w-full md:w-1/2 md:h[663px] flex justify-center mt-8 md:mt-0 relative">
//           {/* Main Image */}
//           <Image
